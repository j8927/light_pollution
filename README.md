...
⦁ YOLOv12 아키텍처를 야간 특화 데이터로 전이 학습하여 미세 광원 탐지 성능을 극대화한다.
...
객관적 빛 공해 관리 기반 마련: 이미지 분석과 YOLOv12 인공지능 기술을 활용하여 외부 조명 및 간판의 밝기 상태를 분석함으로써, 주관적 판단이 아닌 데이터 중심의 객관적 분석 기반을 마련할 수 있습니다.
